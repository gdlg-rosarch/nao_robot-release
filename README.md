## nao_robot (kinetic) - 0.5.15-0

The packages in the `nao_robot` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release nao_robot -r kinetic -t kinetic` on `Wed, 23 Nov 2016 17:42:38 -0000`
...
## nao_robot (jade) - 0.5.15-0

The packages in the `nao_robot` repository were released into the `jade` distro by running `/usr/bin/bloom-release nao_robot -r jade -t jade` on `Wed, 23 Nov 2016 17:38:09 -0000`
...
## nao_robot (indigo) - 0.5.13-0

The packages in the `nao_robot` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo nao_robot` on `Sat, 16 Jan 2016 14:01:12 -0000`
...
## nao_robot (jade) - 0.5.11-0

The packages in the `nao_robot` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade nao_robot` on `Tue, 11 Aug 2015 12:21:11 -0000`
...
The packages in the `nao_robot` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade nao_robot` on `Fri, 31 Jul 2015 10:26:07 -0000`
